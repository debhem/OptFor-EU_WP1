###################################################################################################################################################
# Title: Script for Downloading CERRA 3-hourly Specific Humidity data

# Date: 11th December 2024

# Author: Vlad Alexandru AMIHĂESEI, MeteoRomania, National Meteorological Administration, Romania

# Description: Automates the retrieval of CERRA reanalyses data for the variable "specific_humidity"
...
#              Data are saved in GRIB format with filenames such as 'specific_humidity_03h_1984.grib'

# Inputs: Years of interest: 1984 to 2021
#         Existing files in the directory: "nc/cerra/specific_humidity"
#         CDS API key and user credentials

# Outputs: GRIB files for the variable "specific_humidity" 
#          Saved in the folder "nc/cerra/specific_humidity/" with the naming 
#          Format "specific_humidity_3h_[year].grib"
