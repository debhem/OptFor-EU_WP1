...
input_dir <- "/media/vlad/Elements2/CERRA/raw/runoff"
...
for (i in seq_along(files)) {
  ...
  # Use CDO to calculate daily sum from 3-hourly runoff data:
  # - Adjust time by shifting 1 hour back (-1 hour)
  # - Set the attribute for runoff units to mm
  system(paste0(
...
files.mon <- list.files("/media/vlad/Elements2/CERRA/raw/runoff/", pattern = "MON", full.names = TRUE)
name.seas <- "/media/vlad/Elements2/CERRA/raw/runoff/runoff_SEAS_1984-2021.nc"
