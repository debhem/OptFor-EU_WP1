# ============================================================
# Script for Downloading CERRA Evaporation
# Author: [MeteoRo]
# Date: [10/12/2024]
#
# Description:
...
# The data downloaded is in GRIB format and is saved with filenames corresponding to the year (e.g., 'evapo_1984.grib').
