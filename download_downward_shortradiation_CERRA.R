# ============================================================
# Script for Downloading CERRA Direct Shortwave Radiation Data
# Author: [MeteoRomania]
# Date: [11/12/2024]
#
# Description:
# This script automates the retrieval of CERRA reanalysis data 
# for the variable "time-integrated surface direct shortwave radiation flux."
...
#
# Outputs:
# - GRIB files for the variable "solar downward direct shortwave radiation flux" 
