###################################################################################################################################################
# Title: Script for Downloading CERRA 3-hourly 10m Wind Speed data

# Date: 11th December 2024

# Author: Vlad Alexandru AMIHĂESEI, MeteoRomania, National Meteorological Administration, Romania

# Description: Automates the retrieval of CERRA reanalyses data for the variable "10m wind speed"
...
#                3. Constructs a data request for each missing year, specifying parameters such as the variable (10m wind speed), model level, 3-hourly time steps, and output format
...
#              Data are saved in GRIB format with filenames such as 'ws_03h_1984.grib'

# Inputs: Years of interest: 1984 to 2021
#         Existing files in the directory: "nc/cerra/ws"
#         CDS API key and user credentials

# Outputs: GRIB files for the variable "wind speed" 
#          Saved in the folder "nc/cerra/ws/" with the naming 
#          Format "ws_3h_[year].grib"
