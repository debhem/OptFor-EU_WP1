###################################################################################################################################################
# Title: Script for Downloading CERRA 3-hourly Surface Pressure data

# Date: 11th December 2024

# Author: Vlad Alexandru AMIHĂESEI, MeteoRomania, National Meteorological Administration, Romania

# Description: Automates the retrieval of CERRA reanalyses data for the variable "surface pressure"
...
#                3. Constructs a data request for each missing year, specifying parameters such as the variable (surface pressure), model level, 3-hourly time steps, and output format
...
#              Data are saved in GRIB format with filenames such as 'surface_pressure_03h_1984.grib'

# Inputs: Years of interest: 1984 to 2021
#         Existing files in the directory: "nc/cerra/surface_pressure"
#         CDS API key and user credentials

# Outputs: GRIB files for the variable "surface pressure" 
#          Saved in the folder "nc/cerra/surface_pressure/" with the naming 
#          Format "surface_pressure_3h_[year].grib"
